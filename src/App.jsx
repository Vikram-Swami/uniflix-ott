  ...
  return (
    <>
      ...
      {movieId && <div className="fixed inset-0 bg-[#00050d]/80 z-5000 flex justify-center items-center pt-20 h-screen overscroll-y-auto overflow-x-hidden">
        <p className="whitespace-nowrap">Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime doloremque at commodi eum dolore ea saepe facilis numquam eius id, pariatur doloribus distinctio voluptatum voluptatibus repellat dolorem quisquam nemo natus soluta eligendi aut similique corrupti? Facilis, fugit! Fugiat, ducimus non distinctio doloremque numquam consectetur fugit ab exercitationem. Numquam qui quod ea aspernatur adipisci minus nisi aperiam autem hic iusto magnam ducimus delectus pariatur quia est nobis, deleniti eligendi doloribus explicabo tenetur unde eveniet? Aperiam perspiciatis labore rerum doloribus. Doloremque eaque porro, eius fuga ea eum nobis tenetur, doloribus quisquam assumenda facere adipisci dolores quod exercitationem soluta mollitia earum laboriosam odit.</p>
