...
export default function MovieDetailsPopup({ setMovieDetailsPopupScroll, setMovieData, movieData }) {
    ...
    const bannerImage = `https://imgcdn.kim/pv/c/${movieId}.jpg`;
...
${pageUrl}`;
    ...
    return (
        ...
        }} className="fixed inset-0 z-500 bg-[#00050d] overflow-y-auto movie_details_popup_scroll h-screen xs:h-screen overflow-x-hidden max-md:pt-[50px]">
            {/* Hero Banner Section */}
