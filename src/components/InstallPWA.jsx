...
const InstallPWA = () => {
    ...
    return (
        <div className="flex items-center flex-col h-full justify-end">
            <p className="text-xs xs:text-sm md:text-base">Uniflix is a clone of Prime Video , Netflix and 10+ OTT</p>
            ...
            <p className="flex items-center justify-center gap-3 text-lg py-2"><Copyright className="w-5 h-5" /> 2022 uniflix.fun - Inc.</p>
        </div>
    );
};
