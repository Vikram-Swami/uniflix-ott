...
const MovieRow2 = ({ title, movieIds }) => {
    ...
    return (
        <div className="mt-6 md2:mt-9 2xl:mt-12 max-xs:ps-3 xs:ps-6 sm2:ps-8 md2:ps-11 2xl:ps-[72px]! xs:pe-6 group">
            <h2 className="text-base 6xl:text-sky-500 sm:text-lg xl:text-xl font-semibold mb-2 sm:mb-[11px] 2xl:mb-4 relative -z-10">
                {title}
            </h2>
            <div className={`relative cards_slider group-hover:z-50`}>
                ...
                <button
                    ...
                    rounded-r-lg w-10 2xl:w-12 h-[calc(100%+2px)] bg-black/80 z-20 hidden items-center justify-center
                    ...
                    <span className="scale-120 transition-all duration-300">
                        <ChevronLeft className="w-10 h-10 stroke-red-500"/>
                    </span>
                </button>
                ...
                <button
                    ...
                    rounded-l-md w-10 2xl:w-14 5xl:w-14 h-[calc(100%+2px)] bg-black/80 hidden items-center z-20 justify-center
                    transition-opacity duration-200 cursor-pointer
                    ${reachEnd ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
                    <span className="scale-120 transition-all duration-300">
                        <ChevronRight className="w-10 h-10 stroke-red-500" />
                    </span>
                </button>
            </div>
        </div>
